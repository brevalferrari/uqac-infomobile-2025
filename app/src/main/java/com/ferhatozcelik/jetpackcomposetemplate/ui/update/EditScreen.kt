...
import com.ferhatozcelik.jetpackcomposetemplate.util.getRoutine
...
fun EditScreen(
    ...
    getRoutine(UUID.fromString(routineId!!))?.let {
        ...
        viewModel.setStartDate(it.startTime)
        it.endTime?.let { viewModel.setEndDate(it) }
        viewModel.setPeriod(it.period)
